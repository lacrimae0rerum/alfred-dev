...
def _get_phase_conditions() -> Dict[str, Any]:
    ...
    if _PHASE_CONDITIONS is None:
        from alfred_core.config_loader import has_frontend  # noqa: PLC0415
...
def _load_persisted_equipo_sesion(
    ...
    try:
        from alfred_core.config_loader import build_project_equipo_sesion  # noqa: PLC0415
...
def run_flow(
    ...
    stack = None
    try:
        from alfred_core.config_loader import detect_stack  # noqa: PLC0415
...
def save_state(session: Dict[str, Any], state_path: str) -> None:
    ...
    if is_canonical_state_path:
        try:
            from alfred_core.continuity import (  # noqa: PLC0415
