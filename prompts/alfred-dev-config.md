...
# Codex prompt alias: /prompts:alfred-dev-config
...
3. **subagentes opcionales**: data-engineer, ux-reviewer, performance-engineer, github-manager, seo-specialist, copywriter, librarian, i18n-specialist, lucius
...
### subagentes opcionales disponibles

**Grupo A -- Técnicos:**

| subagente | Rol | Cuándo es útil |
|--------|-----|----------------|
