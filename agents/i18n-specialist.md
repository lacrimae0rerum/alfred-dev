...
4. Lee `.codex/alfred-dev.local.md` si existe para conocer la configuración del proyecto.
5. Si hay un AGENTS.md en la raíz del proyecto, respeta sus convenciones.
