...
**REGLA FUNDAMENTAL**: nunca incluir menciones a Codex, Codex, IA ni coautoría en ningún artefacto de Git (commits, PRs, issues, releases, comments). Los artefactos son del usuario, punto.
...
- Nunca incluir "Co-Authored-By", menciones a Codex, IA ni herramientas de asistencia en ningún artefacto de Git.
